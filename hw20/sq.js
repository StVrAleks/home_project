...
/*Вариант 1*/
/*     if (a == 0)
         return ['Исходные параметры введены неверно. а не может быть равным нулю' ];*/
//
    ...
    function squareRootsTests() {

        {
            ...
            console.log(roots, (roots.length==0)
                ?'пройден':'НЕ ПРОЙДЕН!' )
        }

        {
            ...
            console.log(roots, ((roots.length==2)&&(roots[0]==3)&&(roots[1]==-1))
                ?'пройден':'НЕ ПРОЙДЕН!' )
        }

        {
            ...
            console.log(roots, ((roots.length==2)&&(roots[0]==-5)&&(roots[1]==3))
                ?'пройден':'НЕ ПРОЙДЕН!' )
        }

        {
            ...
            console.log(roots, ((roots.length==1)&&(roots[0]==-6))
                ?'пройден':'НЕ ПРОЙДЕН!' )
        }

        {
            ...
            //console.log(roots, ((roots.length==1)&&(roots[0]==2))
                ?'пройден':'НЕ ПРОЙДЕН!' )
        }
    ...
    function ttt() {
        ...
        const a = Number(prompt('Введите a > 0'));
