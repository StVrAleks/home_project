...
var wrapH11 = buildWrapper('H1');
 ...
 //var wrapP1 = wrapP("Однажды в студёную зимнюю пору");
  //console.log( wrapP1);
  var a = wrapP("Однажды в студёную зимнюю пору");
...
{ 
  ...
  // var wrap = wrapP(this);
   //return partI + wrap + partII;
  // wrapP(text,options) => {
  /* var aaa = function wrapP(text,options) {
   options = options || {};
   var masMnem = {"<":'&#60 ;', ">":'&#62;', "'":'&#39;', '"':'&#34;', "&":'&#38;', ")":'&#41;', ":":'&#58;'};    
   var myStroka = text; 
   var myIndex = text.length || 0; 
   //console.log(myIndex);
   atr = 0;
...
function wrapP(text, options) 
   ...
   let fullStr = atr +">" + y;
   return buildWrapper() + fullStr + buildWrapper();
   }
